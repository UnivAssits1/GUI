		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Cari Indekos</a></li>
        ...
        <div class="container my-5" >
            <div class="row d-flex justify-content-center " style="min-height: 50vh" >
                <div class="col-md-5 justify-content-center align-content-center  my-auto" >
                    ...
                    <div class="btn-conteinerA ">
                        <Button class="btn-contentA " href="#">
                            <span class="btn-title text-center fs-3 text-white">Telusuri</span>
            ...
            <div class="row" >
                <div class="col-md-3 rounded" style="background-color: #F9EAE1; border: 3px solid #AA998F;">
                    ...
                    <div class="ms-3">
                        ...
                        <div class="my-3">
                            <button class="btn text-white mx-1 my-2" type="submit" style="background-color: #AA998F">Air Conditioner</button>
                            <button class="btn text-white mx-1 my-2" type="submit" style="background-color: #AA998F">Kamar Mandi</button>
                            <button class="btn text-white mx-1 my-2" type="submit" style="background-color: #AA998F">WiFi</button>
                            <button class="btn text-white mx-1 my-2" type="submit" style="background-color: #AA998F">Laundry</button>
                        </div>
                    </div>
                ...
                <div class="col-md-9 text-center">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="text" placeholder="Cari Kosan" aria-label="default input example">
                        </div>
                    </div>
                    <div class="row row-cols-1 row-cols-md-4 g-2 my-2 ms-5">
                        <div class="col" >
                            <div class="card" style="background-color: #F9EAE1">
                                <img src="..." class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                    <button type="button" class="btn" style="background-color: #AA998F" >     <span class="text-white">Primary</span></button>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" style="background-color: #F9EAE1">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                    <button type="button " class="btn" style="background-color: #AA998F">
